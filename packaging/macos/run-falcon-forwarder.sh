...
CONFIG_PATH="${BEACON_FALCON_VECTOR_CONFIG:-/Library/Application Support/Beacon/Forwarders/falcon-vector.toml}"
ENV_PATH="${BEACON_FALCON_VECTOR_ENV:-/Library/Application Support/Beacon/Forwarders/falcon-vector.env}"
