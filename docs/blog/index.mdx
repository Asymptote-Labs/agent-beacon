---
title: "Beacon Blog"
description: "Writing from the Beacon team on building secure, observable AI systems."
---

Every Beacon post, newest first. Articles open on
...
<CardGroup cols={2}>
  <Card
    title="Beacon Achieves SOC 2 Type II Compliance"
    icon="shield-check"
  ...
  >
    Our SOC 2 Type II attestation validates that Beacon security controls are operating effectively over time.
  </Card>
  <Card
