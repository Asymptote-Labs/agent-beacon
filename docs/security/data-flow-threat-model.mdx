...
|------|-----------------|
| Unintended hosted telemetry | Managed is preselected in interactive onboarding, but selection and account sign-in do not forward anything. Forwarding starts only after the separate connect command, sends only new lines, records the active privacy mode, and stops within a minute of revocation |
