...
description: "Beacon is the open-source trace and reviewed-memory layer for AI agents."
---
...
Every run can add to the local trace history. Reusable project memory is created
only when you explicitly evaluate traces and approve candidates.
