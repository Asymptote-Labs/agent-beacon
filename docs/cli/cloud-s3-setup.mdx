...
<Warning>
  ...
  For production enterprise deployments, use [Beacon Managed](/deployment/managed)
  or contact Beacon about secure forwarding in customer-managed infrastructure.
</Warning>
