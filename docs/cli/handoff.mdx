...
- **Live hooks.** The prompt hook for Claude Code and Grok Build and the Cline and OpenCode plugins record it as the prompt is sent (`harness.collection_method: hook`).
