...
| Beacon Managed | Shows what will be sent, records the choice, and prints `beacon endpoint connect` as a separate next step. Nothing is forwarded during the wizard. |
