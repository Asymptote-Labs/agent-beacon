...
description: "Report token usage and attribution from the Beacon endpoint runtime log"
---

## Command Overview

`beacon token-usage` reads Beacon endpoint events from the runtime JSONL log and summarizes token usage, cost, models, sessions, runs, harnesses, and repositories.
