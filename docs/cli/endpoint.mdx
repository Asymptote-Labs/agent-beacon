...
<Columns cols={2}>
  ...
  <Card title="beacon endpoint connect" icon="link" href="/cli/endpoint-connect">
    Approve this device in the Asymptote dashboard and start the Vector forwarder.
  </Card>
  <Card title="beacon endpoint disconnect" icon="link-slash" href="/cli/endpoint-connect">
    Stop the Asymptote forwarder and remove the local device key.
  </Card>
  ...
  <Card title="beacon endpoint asymptote" icon="tower-broadcast" href="/cli/asymptote">
    Generate the Asymptote forwarding pack for running Vector by hand.
  </Card>
