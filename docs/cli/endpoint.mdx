...
<span id="beacon-endpoint-onboarding" />
<span id="beacon-endpoint-fx" />
<span id="beacon-endpoint-connect" />
<span id="beacon-endpoint-disconnect" />
<span id="beacon-endpoint-asymptote" />
<span id="beacon-endpoint-traces" />
...
<Columns cols={2}>
  ...
  <Card title="beacon endpoint connect" icon="link" href="/cli/endpoint-connect">
    Enroll this device with the signed-in CLI account and start the Vector forwarder. System mode uses browser approval.
  </Card>
  <Card title="beacon endpoint disconnect" icon="link-slash" href="/cli/endpoint-connect">
    Stop the Beacon forwarder and remove the local device key.
  </Card>
  ...
  <Card title="beacon endpoint onboarding" icon="envelope" href="/cli/endpoint-onboarding">
    Show, reset, or resend the one-time onboarding record.
  </Card>
  <Card title="beacon endpoint fx" icon="rotate" href="/cli/endpoint-fx">
    Collect telemetry from fx session records on this machine.
  </Card>
  <Card title="beacon endpoint copilot" icon="rotate" href="/cli/endpoint-copilot">
    Collect telemetry from GitHub Copilot CLI session records.
  </Card>
  <Card title="beacon endpoint dsh" icon="rotate" href="/cli/endpoint-dsh">
    Collect telemetry from DeepSeek Harness session records.
  </Card>
  <Card title="beacon endpoint traces" icon="magnifying-glass" href="/cli/endpoint-traces">
    Index, list, search, and show local traces from runtime logs.
  </Card>
  <Card title="beacon endpoint asymptote" icon="tower-broadcast" href="/cli/asymptote">
    Generate the Beacon forwarding pack for running Vector by hand.
  </Card>
