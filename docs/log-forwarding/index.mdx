...
<Columns cols={2}>
  ...
  <Card title="Google Cloud Storage" icon="box-archive" href="/log-forwarding/gcs">
    Vector content pack over runtime and inventory JSONL using customer-managed Google credentials.
  </Card>
</Columns>
...
See [Google Cloud Storage forwarding](/log-forwarding/gcs) for IAM, object
layout, Vector `0.56` authentication limits, safe credential delivery and
rotation, smoke testing, and validation with a separate reader identity.
