...
If you use a customer-managed forwarder instead of Beacon's collector destination, store the token in that forwarder's secret store rather tha Beacon configuration.
