...
- **Plainer onboarding copy** · The wizard explained itself twice and repeated the
  ...
  free, unlimited cloud-based retention of every agent session, AI-powered search
  and analytics on the hosted dashboard, and rich findings analyzing AI usage
  coming soon; Local as a dashboard for this machine alone
