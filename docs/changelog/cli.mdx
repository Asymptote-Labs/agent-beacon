...
- **Plainer onboarding copy** · The wizard explained itself twice and repeated the
  ...
  The destination choice describes what you actually get from each: Managed as the
  full dashboard with AI-powered search and analytics, findings and detections
  across every machine and kept indefinitely, Local as a basic single-machine dashboard for
  exploring Beacon or keeping data off the network, each saying when to pick it.
