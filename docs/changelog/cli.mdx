...
- **Harness-neutral object storage guide** · Consolidated the Claude-specific single-Mac S3 and GCS walkthroughs into one system-mode guide for any configured harness, while keeping provider IAM, credential, and validation details in the dedicated destination references.
