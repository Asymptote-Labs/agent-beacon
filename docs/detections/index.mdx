...
| `agent-control` | Agent CLIs spawned with permission-elevating env vars, sandbox-escape primitives, inter-agent credential handoff, injected instructions persisted into a self-improving agent's durable harness |
