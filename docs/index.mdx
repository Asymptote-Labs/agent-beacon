...
Beacon is the open-source self-improving memory layer for AI agents. It was designed and built by the founders of [Asymptote Labs](https://asymptotelabs.ai/).
...
Use Beacon to understand agent behavior, debug workflows, and turn what your agents learn into reusable knowledge that compounds across harnesses.
