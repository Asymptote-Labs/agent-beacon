...
description: "Wrap Claude Agent SDK query functions with Beacon Observe"
---

## Integration overview

Use this integration when your application runs Claude Agent SDK queries through `@anthropic-ai/claude-agent-sdk`. Beacon Observe can wrap the query function to create a Beacon-compatible root span for each agent turn.
