---
title: "Anthropic"
description: "Instrument Anthropic SDK calls with Beacon Observe"
---
...
Initialize Beacon Observe before creating the Anthropic client when possible. The instrumentation captures supported Anthropic SDK spans without changing the way you call `anthropic.messages.create()`.
...
```bash title="Set Beacon Managed and Anthropic environment variables"
