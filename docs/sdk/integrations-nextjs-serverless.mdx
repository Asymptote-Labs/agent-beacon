...
description: "Initialize Beacon Observe in Next.js and short-lived serverless runtimes"
---
...
Serverless and preview environments can send to a customer-managed collector by setting `OTEL_EXPORTER_OTLP_ENDPOINT` instead of Beacon Managed hosted Observe credentials.
...
Explicit OTLP export does not require a Beacon Managed `ASYMPTOTE_API_KEY`.
