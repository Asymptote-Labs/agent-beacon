...
The final status check should show a recent last Beacon event. If you open the
dashboard, the local activity views should include the synthetic validation event.
