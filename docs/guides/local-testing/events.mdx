...
The status output should include a recent last Beacon event when the runtime log
has been written successfully. The dashboard should show the validation event in
local activity views.
