...
description: "Inventory local agent runtimes, skills, MCP servers, and Beacon-observable configuration"
---
...
- Which runtime config files ca Beacon inspect locally?
...
<Columns cols={2}>
  ...
  <Card title="beacon endpoint dashboard" icon="chart-line" href="/cli/dashboard">
    Open the local dashboard and review Agent Activity, Agent Inventory, and Memory.
  </Card>
