...
For managed fleets, use the dedicated [Jamf S3 guide](/guides/jamf-s3-mdm),
[Fleet S3 guide](/guides/fleet-s3-mdm), or [Jamf GCS guide](/guides/jamf-gcs-mdm).
Those guides cover package install, credential delivery, and the Vector
LaunchDaemon that tails the local JSONL files.
