...
[[hooks]]
event = 'SessionStart'
command = "'/opt/beacon/bin/beacon-hooks' --platform kimi --log '/var/log/beacon-agent/runtime.jsonl' session-start"
timeout = 10

[[hooks]]
event = 'UserPromptSubmit'
command = "'/opt/beacon/bin/beacon-hooks' --platform kimi --log '/var/log/beacon-agent/runtime.jsonl' prompt-submit"
timeout = 30
```
