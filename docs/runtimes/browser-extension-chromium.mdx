...
| Firefox | Beta, separate build | Not Chromium: a separate `dist-firefox` build, linted in CI and checked by hand. See [Load it in Firefox](/runtimes/browser-extension#load-it-in-firefox) |
| Safari | Not supported | Different extension platform. Tracked separately |
