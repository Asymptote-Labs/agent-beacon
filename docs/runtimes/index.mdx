...
| [Prime Agent](/runtimes/prime-agent) | Managed extension hooks | Session lifecycle, prompts, Python kernel cells as commands with output and duration, streamed file edits, agent-to-agent messages, context compaction, harness self-modification, agent reasoning, and token usage |
