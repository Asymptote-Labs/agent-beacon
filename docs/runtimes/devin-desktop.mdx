---
title: "Devin Desktop"
description: "Beacon support details for Devin Desktop endpoint telemetry"
---

## Runtime overview

Beacon supports Devin Desktop through Cascade/Windsurf-compatible hook payloads sent to `beacon-hooks`.
...
- Beacon hooks are installed with `beacon endpoint hooks install --harness devin-desktop`.
...
Devin Desktop invokes Beacon's hook adapter through Cascade/Windsurf hook files. The adapter writes normalized endpoint events to the configured runtime JSONL log.
