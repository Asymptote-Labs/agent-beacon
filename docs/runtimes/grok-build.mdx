...
Grok Build is the xAI terminal coding agent. It is a different product from
[Grok Bot](/runtimes/grok-bot), xAI's cloud-hosted agent, which Beacon records
under the separate `grok_bot` harness.
