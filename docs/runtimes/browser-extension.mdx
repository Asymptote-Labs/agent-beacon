...
- You have Chrome, or another Chromium browser that can load an unpacked MV3 extension, or Firefox 140 or newer for the Firefox build. Safari is not supported.
...
| MDM deployment | Not covered by Beacon's MDM assets. Distribute through browser policy instead, such as Firefox's [`ExtensionSettings`](#firefox-enterprise-policy) |
