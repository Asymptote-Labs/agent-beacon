---
title: "Claude.ai"
description: "Beacon support details for Claude.ai browser chat telemetry"
---

## Runtime overview

Beacon collects Claude.ai chat telemetry through the optional [browser extension](/runtimes/browser-extension). Every turn on claude.ai becomes prompt, response, and tool events in the local runtime log, attributed to the `claude_web` harness so it stays separate from Claude Code and other CLI agents.
