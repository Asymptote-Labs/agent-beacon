...
<Tabs>
  ...
  <Tab title="Other agents">
    For Cursor, Gemini CLI, OpenCode, goose, Kiro, Pi, Hermes Agent, and any other agent
    that reads Agent Skills, use the skills CLI:
    ...
    Cline reads `.cline/skills` rather than `.agents/skills`, so copy the skills there
    from [`agent-skills/skills`](https://github.com/asymptote-labs/agent-beacon/tree/main/agent-skills/skills).
    The [README](https://github.com/asymptote-labs/agent-beacon#local-agent-coverage)
    lists the install route for every supported runtime.
  </Tab>
</Tabs>
