...
func TestNormalizeEndpointTargetCharacterization(t *testing.T) {
	...
	cases := map[string]want{
		...
		"cline":           {"cline", endpointTargetHook, true},
		"prime":           {"prime", endpointTargetHook, true},
		"prime-agent":     {"prime", endpointTargetHook, true},
		"prime_agent":     {"prime", endpointTargetHook, true},
		"grok":            {"grok", endpointTargetHook, true},
		"qwen":            {"qwen", endpointTargetHook, true},
		"qwen-code":       {"qwen", endpointTargetHook, true},
		"qwen_code":       {"qwen", endpointTargetHook, true},
