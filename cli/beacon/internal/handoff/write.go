...
// WriteBrief stores a rendered brief under dir and returns its path. The directory is private to
// the user (0700) and the file is 0600, because a brief carries prompt text and command output.
