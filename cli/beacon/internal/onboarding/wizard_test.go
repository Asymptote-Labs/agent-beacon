...
func TestDestinationCaptionsNameTheValueNotTheMechanism(t *testing.T) {
	...
	for _, want := range []string{"Free, unlimited cloud-based retention", "AI-powered search and analytics on Beacon's hosted dashboard", "findings and detections", "full feature set"} {
