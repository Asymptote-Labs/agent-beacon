...
func TestOneCallDescribedInDifferentWordsCollapses(t *testing.T) {
	...
	hook := withIDAndMessage(base[1], "18:00:01.000000000Z", "Shell command executed")
	collector := withIDAndMessage(base[1], "18:00:07.000000000Z", "Tool execution observed")
...
func TestMultiEditToTwoFilesUnderOneCallIDKeepsBoth(t *testing.T) {
	...
	edit := func(path string) string {
		return `{"timestamp":"2026-08-02T18:00:01.000000000Z","vendor":"beacon","product":"endpoint-agent",` +
